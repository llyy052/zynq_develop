...
def download():
    ...
    #SEND_CMD("lcd Z:/zynq/zynq_develop/driver/spi")
    #SEND_CMD("put axi_pwm.ko")

    SEND_CMD("lcd Z:/zynq/zynq_develop/driver/spi/ads7952")
    SEND_CMD("put ads7952_test.elf")
...
def run():
    ...
    #SEND_CMD("mknod /dev/spi-0 c 153 0")
    SEND_CMD("chmod 777 ads7952_test.elf")

    SEND_CMD("./ads7952_test.elf")
